...
var messages = {
    ...
    assault : {
        failed : {
            ...
            blocked : [
                [ "As ", 0, " steps forward to assault, ", 1, " steps forward to block, anticipating the attack and stopping it before it's begun." ],
                [ 0, " charges in, but the blow is blocked by ", 1, "." ],
